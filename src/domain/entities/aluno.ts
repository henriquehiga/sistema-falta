...
export class Aluno {
  private constructor(private readonly _props: AlunoProps) {
  }

  static create(props: AlunoProps): Either<ErrorResponse, Aluno> {
  ...
  static validate({ id, nome, email }: AlunoProps): ValidateAlunoPropsResponse {
